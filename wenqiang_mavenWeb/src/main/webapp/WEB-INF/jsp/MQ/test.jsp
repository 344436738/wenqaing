...
<html>
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
          <script type="text/javascript" src="/wenqiang_mavenWeb/static/js/jquery-1.7.2.js"></script>
     </head>   
<body>
<br/><br/><br/>
...
<script type="text/javascript">
	$("#pushUser").click(function(){
		...
		ajaxDo("/wenqiang_mavenWeb/action/push/user",data);
	});
	$("#pushNews").click(function(){
		...
		ajaxDo("/wenqiang_mavenWeb/action/push/news",data);
	});
	$("#pushClient").click(function(){
		...
		ajaxDo("/wenqiang_mavenWeb/action/push/client",data);
	});
